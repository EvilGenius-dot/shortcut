...
VERSION="3.9.91"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/53/linux"
ORIGIN_EXEC="ttw2-${VERSION}"

SERVICE_NAME="ttw2service"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/ttw2\/ttw2\ &/d' /etc/rc.local
    fi
