...
VERSION="4.1.4"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/37/linux"
ORIGIN_EXEC="ntminer-${VERSION}"

SERVICE_NAME="ntminerservice"

PATH_RUST="/root/ntminer"
PATH_EXEC="ntminer"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/ntminer\/ntminer\ &/d' /etc/rc.local
    fi
