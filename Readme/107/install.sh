...
VERSION="4.4.8"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/107/linux"
ORIGIN_EXEC="tominer-${VERSION}"

SERVICE_NAME="tominerservice"

PATH_RUST="/root/tominer"
PATH_EXEC="tominer"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sed -i '/\/root\/tominer\/tominer\ &/d' /etc/rc.local
    fi
