...
VERSION="3.9.9"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/57/linux"
ORIGIN_EXEC="tietouwa-${VERSION}"

SERVICE_NAME="tietouwaservice"

PATH_RUST="/root/tietouwa"
PATH_EXEC="tietouwa"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/tietouwa\/tietouwa\ &/d' /etc/rc.local
    fi
