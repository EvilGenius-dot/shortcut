...
VERSION="4.4.7"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/110/linux"
ORIGIN_EXEC="yudhd-${VERSION}"

SERVICE_NAME="yudhdservice"

PATH_RUST="/root/yudhd"
PATH_EXEC="yudhd"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sed -i '/\/root\/yudhd\/yudhd\ &/d' /etc/rc.local
    fi
