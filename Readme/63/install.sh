...
VERSION="4.3.1"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/63/linux"
ORIGIN_EXEC="xxminer2-${VERSION}"

SERVICE_NAME="xxminer2service"

PATH_RUST="/root/xxminer2"
PATH_EXEC="xxminer2"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/xxminer2\/xxminer2\ &/d' /etc/rc.local
    fi
