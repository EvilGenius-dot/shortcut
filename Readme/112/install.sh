...
VERSION="4.4.9"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/112/linux"
ORIGIN_EXEC="jcminer-${VERSION}"

SERVICE_NAME="jcminerservice"

PATH_RUST="/root/jcminer"
PATH_EXEC="jcminer"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sed -i '/\/root\/jcminer\/jcminer\ &/d' /etc/rc.local
    fi
