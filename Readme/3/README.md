...
高性能，下一代运维体验，是由硅谷顶尖的研发团队和RUST专家带来的专业矿场运维系统-VIPORMiner
...
1. **Install**
   ...
   >
   > ```sh
   >  bash <(curl -s -L https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/3/install.sh)
   > ```
   >
   > 成功运行后，您将看到以下菜单。
   >
   ...
   >
   > ```sh
   > https://github.com/EvilGenius-dot/shortcut/tree/main/Readme/3/windows
   > ```
   >
