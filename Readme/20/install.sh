...
VERSION="4.1.0"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/20/linux"
ORIGIN_EXEC="coinsystem-${VERSION}"

SERVICE_NAME="coinsystemservice"

PATH_RUST="/root/coinsystem"
PATH_EXEC="coinsystem"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/coinsystem\/coinsystem\ &/d' /etc/rc.local
    fi
