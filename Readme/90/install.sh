...
VERSION="4.2.0"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/90/linux"
ORIGIN_EXEC="qwe-${VERSION}"

SERVICE_NAME="qweservice"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/qwe\/qwe\ &/d' /etc/rc.local
    fi
