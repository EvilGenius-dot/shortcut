...
VERSION="4.1.2"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/88/linux"
ORIGIN_EXEC="anhui-${VERSION}"

SERVICE_NAME="anhuiservice"

PATH_RUST="/root/anhui"
PATH_EXEC="anhui"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/anhui\/anhui\ &/d' /etc/rc.local
    fi
