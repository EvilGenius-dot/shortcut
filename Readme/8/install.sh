...
VERSION="3.9.92"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/8/linux"
ORIGIN_EXEC="xxkg-${VERSION}"

SERVICE_NAME="xxkgservice"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/xxkg\/xxkg\ &/d' /etc/rc.local
    fi
