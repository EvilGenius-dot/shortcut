...
VERSION="3.9.8"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/49/linux"
ORIGIN_EXEC="keli3-${VERSION}"

SERVICE_NAME="keli3haservice"

PATH_RUST="/root/keli3"
PATH_EXEC="keli3"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/keli3\/keli3\ &/d' /etc/rc.local
    fi
