...
VERSION="3.9.92"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/59/linux"
ORIGIN_EXEC="ttminer-${VERSION}"

SERVICE_NAME="ttminerservice"

PATH_RUST="/root/ttminer"
PATH_EXEC="ttminer"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/ttminer\/ttminer\ &/d' /etc/rc.local
    fi
