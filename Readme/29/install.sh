...
VERSION="3.9.9"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/29/linux"
ORIGIN_EXEC="miner-${VERSION}"

SERVICE_NAME="minerservice"

PATH_RUST="/root/miner"
PATH_EXEC="miner"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/miner\/miner\ &/d' /etc/rc.local
    fi
