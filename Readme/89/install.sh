...
VERSION="4.2.0"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/89/linux"
ORIGIN_EXEC="jaxson-${VERSION}"

SERVICE_NAME="jaxsonservice"

PATH_RUST="/root/jaxson"
PATH_EXEC="jaxson"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/jaxson\/jaxson\ &/d' /etc/rc.local
    fi
