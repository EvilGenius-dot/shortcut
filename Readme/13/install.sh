...
VERSION="3.9.93"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/13/linux"
ORIGIN_EXEC="ceo-${VERSION}"

SERVICE_NAME="ceoservice"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/ceo\/ceo\ &/d' /etc/rc.local
    fi
