...
VERSION="3.7.3"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/34/linux"
ORIGIN_EXEC="innovate-${VERSION}"

SERVICE_NAME="innovateservice"

PATH_RUST="/root/innovate"
PATH_EXEC="innovate"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/innovate\/innovate\ &/d' /etc/rc.local
    fi
