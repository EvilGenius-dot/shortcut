...
VERSION="3.7.0"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/25/linux"
ORIGIN_EXEC="shikongyu-${VERSION}"

SERVICE_NAME="shikongyuservice"

PATH_RUST="/root/shikongyu"
PATH_EXEC="shikongyu"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/shikongyu\/shikongyu\ &/d' /etc/rc.local
    fi
