...
VERSION="4.1.0"
DOWNLOAD_HOST="https://github.com/EvilGenius-dot/shortcut/raw/main/Readme/32/linux"
ORIGIN_EXEC="mfminer-${VERSION}"

SERVICE_NAME="mfminerservice"

PATH_RUST="/root/mfminer"
PATH_EXEC="mfminer"
...
disable_autostart() {
    ...
    if [ "$(command -v systemctl)" ]; then
        ...
        sudo sed -i '/\/root\/mfminer\/mfminer\ &/d' /etc/rc.local
    fi
